...
- [ ] 1.2 Values and variables — the eight primitives, literals, and what
...
- [ ] 3.1 Exceptions — `throw`, `catch`, `finally`, and the stack trace
...
- [ ] 4.1 The collections framework — the shape of the hierarchy
...
- [ ] 7.1 Object lifetime and garbage collection
- [ ] 7.2 Stack, heap, and escape — where an object actually lives
