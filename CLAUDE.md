...
under way: 8.1 is written, and the next unticked chapter is 8.2, The memory
model. As of the last full run: 266 samples and 96 problems, all verified. The site is live at
