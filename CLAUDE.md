...
1.1–1.7) in `docs/ROADMAP.md` are done. Wave B is under way: 2.1–2.2 are
written. As of the last full run: 61 samples and 18 problems, all verified. The site is live at
