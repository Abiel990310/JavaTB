...
Wave E (5.1–5.4) and Wave F (6.1–6.5) are done. Wave G is under way: 7.1–7.2 are
written, and the next unticked chapter is 7.3, Class loading and initialisation
order. As of the last full run: 230 samples and 84 problems, all verified. The site is live at
