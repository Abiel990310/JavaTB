...
1.1–1.7) in `docs/ROADMAP.md` are done. Wave B is under way: 2.1–2.11 are
written. As of the last full run: 98 samples and 36 problems, all verified. The site is live at
