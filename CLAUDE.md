...
and Wave B (2.1–2.12) in `docs/ROADMAP.md` are done. Wave C is under way: 3.1 is
written. As of the last full run: 109 samples and 40 problems, all verified. The site is live at
