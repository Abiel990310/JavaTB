...
Wave E (5.1–5.4) and Wave F (6.1–6.5) are done. Wave G is under way: 7.1–7.5 are
written, and the next unticked chapter is 7.6, Files and NIO. As of the last
full run: 248 samples and 90 problems, all verified. The site is live at
