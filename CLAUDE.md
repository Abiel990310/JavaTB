...
and Wave E (5.1–5.4) are done. Wave F is under way: 6.1–6.2 are written. The next
unticked chapter is 6.3, Streams. As of the
last full run: 195 samples and 74 problems, all verified. The site is live at
