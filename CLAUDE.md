...
1.1–1.7) in `docs/ROADMAP.md` are done. Wave B is under way: 2.1 is
written. As of the last full run: 57 samples and 16 problems, all verified. The site is live at
