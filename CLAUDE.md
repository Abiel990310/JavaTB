...
done. Wave I is under way: 9.1–9.3 are written, and the next unticked chapter is
9.4, Measuring performance without lying to yourself. As of the last full run:
305 samples and 112 problems, all verified. The site is live at
