...
1.1–1.7) in `docs/ROADMAP.md` are done. Wave B is under way: 2.1–2.4 are
written. As of the last full run: 69 samples and 22 problems, all verified. The site is live at
