...
Wave E (5.1–5.4) and Wave F (6.1–6.5) are done. Wave G is under way: 7.1–7.4 are
written, and the next unticked chapter is 7.5, The classpath and the module
system. As of the last full run: 244 samples and 88 problems, all verified. The site is live at
