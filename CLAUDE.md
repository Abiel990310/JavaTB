...
1.1–1.7) in `docs/ROADMAP.md` are done. Wave B is under way: 2.1–2.9 are
written. As of the last full run: 89 samples and 32 problems, all verified. The site is live at
