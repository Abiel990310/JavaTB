...
**Status: Parts 1 and 2 are complete.** Wave 0 (the engine), Wave A (1.1–1.7)
and Wave B (2.1–2.12) in `docs/ROADMAP.md` are done. Wave C is under way: 3.1–3.2 are
written. As of the last full run: 114 samples and 42 problems, all verified. The site is live at
