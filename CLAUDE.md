...
1.1–1.7) in `docs/ROADMAP.md` are done. Wave B is under way: 2.1–2.3 are
written. As of the last full run: 64 samples and 20 problems, all verified. The site is live at
