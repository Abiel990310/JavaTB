...
done. Wave I is under way: 9.1–9.4 are written, and the next unticked chapter is
9.5, API design in Java. As of the last full run: 309 samples and 114 problems,
all verified. The site is live at
