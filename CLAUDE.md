...
1.1–1.7) in `docs/ROADMAP.md` are done. Wave B is under way: 2.1–2.6 are
written. As of the last full run: 77 samples and 26 problems, all verified. The site is live at
