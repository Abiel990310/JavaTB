...
**Status: Part 1 is complete.** Wave 0 (the engine) and Wave A (chapters
1.1–1.7) in `docs/ROADMAP.md` are done. Wave B is under way: 2.1–2.10 are
written. As of the last full run: 94 samples and 34 problems, all verified. The site is live at
