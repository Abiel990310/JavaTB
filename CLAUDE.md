...
and Wave B (2.1–2.12) in `docs/ROADMAP.md` are done. Wave C is under way: 3.1–3.4 are
written. As of the last full run: 122 samples and 46 problems, all verified. The site is live at
